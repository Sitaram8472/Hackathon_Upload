...
const Contact = () => {
  const staffCoordinators = [
    { name: "Dr. A. Kumar", role: "Staff Coordinator", phone: "+91 98765 43210", email: "akumar@college.edu" },
    { name: "Prof. R. Sharma", role: "Staff Coordinator", phone: "+91 87654 32109", email: "rsharma@college.edu" },
  ];

  const studentCoordinators = [
    { name: "Sitaram Sahu", role: "Student Coordinator", phone: "+91 99999 88888", email: "sitaram@college.edu" },
    { name: "Ananya Singh", role: "Student Coordinator", phone: "+91 88888 77777", email: "ananya@college.edu" },
  ];
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-12 w-full max-w-6xl mb-16">
        ...
        <div className="bg-white shadow-lg rounded-2xl p-8 border-t-4 border-sky-500">
          <h3 className="text-2xl font-bold text-sky-700 mb-6">Staff Coordinators</h3>
        ...
        <div className="bg-white shadow-lg rounded-2xl p-8 border-t-4 border-sky-500">
          <h3 className="text-2xl font-bold text-sky-700 mb-6">Student Coordinators</h3>
          <ul className="space-y-6">
      ...
      <div className="text-center mt-10">
        ...
        <p className="text-gray-600 mt-2">
          ...
          <span className="text-sky-600 font-semibold">hackathon@college.edu</span>
        </p>
      </div>
    </section>
  );
